...
const GenerateChat = () => {
  ...
  useEffect(() => {
    // Simulate user authentication and previous graphs (replace with actual logic)
    const token = localStorage.getItem("token");
    // const token = true; // Simulate user being logged in
    if (token) {
      setIsAuthenticated(true);
      // Simulate fetching previously accessed graphs/chats
      setPreviousGraphs([
        { id: 1, title: "Graph 1", description: "Knowledge graph 1" },
        { id: 2, title: "Graph 2", description: "Knowledge graph 2" },
        { id: 3, title: "Graph 3", description: "Knowledge graph 3" },
        { id: 4, title: "Graph 4", description: "Knowledge graph 4" },
      ]);
    } else {
  ...
  return (
    <div className="bg-black overflow-hidden">
      ...
      >
        ...
        {isAuthenticated && previousGraphs.length > 0 ? (
